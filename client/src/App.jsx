...
import AdminSubmissionsListPage from "./pages/AdminSubmissionsListPage";
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route element={<AppLayout />}>
            ...
            <Route
              ...
              element={<AdminExecutivesListPage />}
            />
            <Route
              path="/admin/executive/new"
              element={<AdminExecutiveEditPage />}
            />
            <Route
              path="/admin/executive/:id/edit"
              element={<AdminExecutiveEditPage />}
            />
            <Route
              path="/admin/materials"
              element={<AdminMaterialsListPage />}
            />
            <Route
              path="/admin/material/new"
              element={<AdminMaterialEditPage />}
            />
            <Route
            ...
            />
            <Route
              path="/admin/submission/:id/review"
