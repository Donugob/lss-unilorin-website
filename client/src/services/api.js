...
export const updateExecutive = (id, execData) =>
  api.put(`/executives/${id}`, execData);
...
export const updateEpisode = (id, episodeData) =>
  api.put(`/podcast/${id}`, episodeData);
export const deleteEpisode = (id) => api.delete(`/podcast/${id}`);

// --- Submissions ---
export const uploadSubmissionImage = (formData) =>
  api.post("/upload/public", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
export const createSubmission = (submissionData) =>
  api.post("/submissions", submissionData);
export const getAllSubmissionsAdmin = () => api.get("/submissions/all");
export const getSubmissionById = (id) => api.get(`/submissions/${id}`);
export const approveSubmission = (id, postData) =>
  api.post(`/submissions/${id}/approve`, postData);
